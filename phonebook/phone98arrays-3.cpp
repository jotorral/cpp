...
void PhoneBook::displayContacts()
{
	...
	{
		std::cout << "|" << std::setiosflags(std::ios::right) << std::setw(10) << i << "|" << std::setiosflags(std::ios::right) << std::setw(10) << contacts[i]._firstName << "|" << std::setiosflags(std::ios::right) << std::setw(10) << contacts[i]._lastName << "|" << std::setiosflags(std::ios::right) << std::setw(10) << contacts[i]._nickname << "|" << std::endl;
		std::cout << "---------------------------------------------" << std::endl;
	}
